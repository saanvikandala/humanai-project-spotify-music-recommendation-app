...
def redrawAll(app, canvas):
    ...
    if app.currentScreen == 'home':
        ...
        canvas.create_text(app.width//2, app.height//3 + 120, text="K-Means graph will pop up. The K-Means graph uses your input song data to", fill="black", font="Arial 16")
        canvas.create_text(app.width//2, app.height//3 + 140, text="create a visual representation of the algorithm's clusters of the recommended,", fill="black", font="Arial 16")
        canvas.create_text(app.width//2, app.height//3 + 160, text="liked, and non-liked songs.", fill="black", font="Arial 16")
