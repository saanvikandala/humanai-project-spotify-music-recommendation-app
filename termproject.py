...
def redrawAll(app, canvas):
    ...
    if app.currentScreen == 'home':
        canvas.create_text(app.width//2, app.height//3, text="Welcome to the Music Recommendation App!", fill="black", font="Script 18 bold")
        canvas.create_image(app.width//2, app.height//3 + 100, image=ImageTk.PhotoImage(app.logoImage))
    
        # draw upload button w/ adjusted y pos.
        buttonTopY = app.height//2 + 100
